        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
            ...
            <div class="p-6 space-y-6">
                ...
                <div>
                    ...
                    <textarea wire:model="disposisi" rows="3" class="w-full px-3.5 py-2.5 border border-gray-200 rounded-xl text-sm focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-400 transition-colors min-h-[100px]" placeholder="Catatan disposisi untuk pimpinan..."></textarea>
                </div>
            </div>
        </div>
