...
<head>
    <meta charset="utf-8">
    <title>SKTM - {{ $doc->nomor_surat }}</title>
    <style>
        ...
        .keperluan { margin-top: 20px; text-align: justify; }
...
<body>
    ...
    <div class="data">
        <table>
            ...
            <tr><td>Desil</td><td>: {{ $doc->desil }}</td></tr>
        </table>
    </div>

    <div class="keperluan">
        <p>Berdasarkan data tersebut, yang bersangkutan adalah warga tidak mampu. Surat keterangan ini dibuat untuk {{ $doc->peruntukan }}.</p>
    </div>
